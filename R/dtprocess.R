...
#'@description plot of the processus of the model decision tree

DecisTreeProcPlot = function(splitrat){
  library(rattle)
  library(ggplot2)
  library(readr)
  library(lattice)
  ...
  fancyRpartPlot(mydt$finalModel, palette=c("Oranges","Greys"),main="Mushrooms Attributes Classification")
